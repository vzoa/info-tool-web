...
public class Area
{
    ...
    [JsonPropertyName("visibilityCenter")] public VisibilityCenter VisibilityCenter { get; set; }

    [JsonPropertyName("surveillanceRange")]
    public int SurveillanceRange { get; set; }

    [JsonPropertyName("ssaAirports")] public List<string> SsaAirports { get; set; }
...
{
    [JsonPropertyName("videoMapId")] public string VideoMapId { get; set; }

    [JsonPropertyName("defaultRotation")] public int DefaultRotation { get; set; }

    [JsonPropertyName("defaultZoomRange")] public int DefaultZoomRange { get; set; }
    ...
    [JsonPropertyName("fixRules")] public List<FixRule> FixRules { get; set; }
    ...
    [JsonPropertyName("towerLocation")] public TowerLocation TowerLocation { get; set; }
}
...
public class BeaconCodeBank
{
    ...
    [JsonPropertyName("type")] public BankType Type { get; set; }

    [JsonPropertyName("start")] public int Start { get; set; }

    [JsonPropertyName("end")] public int End { get; set; }

    [JsonPropertyName("category")] public BankCategory Category { get; set; }

    [JsonPropertyName("priority")] public BankPriority Priority { get; set; }
...
{
    [JsonPropertyName("nasId")] public string NasId { get; set; }

    [JsonPropertyName("geoMaps")] public List<GeoMap> GeoMaps { get; set; }
    ...
    [JsonPropertyName("internalAirports")] public List<object> InternalAirports { get; set; }

    [JsonPropertyName("beaconCodeBanks")] public List<BeaconCodeBank> BeaconCodeBanks { get; set; }

    [JsonPropertyName("starsHandoffIds")] public List<StarsHandoffId> StarsHandoffIds { get; set; }

    [JsonPropertyName("referenceFixes")] public List<string> ReferenceFixes { get; set; }

    [JsonPropertyName("asrSites")] public List<object> AsrSites { get; set; }
...
public class ExternalBay
{
    ...
    [JsonPropertyName("bayId")] public string BayId { get; set; }
}
...
public class Facility
{
    ...
    [JsonPropertyName("type")] public FacilityType Type { get; set; }

    [JsonPropertyName("name")] public string Name { get; set; }

    [JsonPropertyName("childFacilities")] public List<Facility> ChildFacilities { get; set; }
...
public class FilterMenu
{
    ...
    [JsonPropertyName("labelLine1")] public string LabelLine1 { get; set; }

    [JsonPropertyName("labelLine2")] public string LabelLine2 { get; set; }
}
...
{
    [JsonPropertyName("stripBays")] public List<StripBay> StripBays { get; set; }

    [JsonPropertyName("externalBays")] public List<ExternalBay> ExternalBays { get; set; }

    [JsonPropertyName("displayDestinationAirportIds")]
    public bool DisplayDestinationAirportIds { get; set; }

    [JsonPropertyName("displayBarcodes")] public bool DisplayBarcodes { get; set; }
...
public class GeoMap
{
    ...
    [JsonPropertyName("filterMenu")] public List<FilterMenu> FilterMenu { get; set; }

    [JsonPropertyName("bcgMenu")] public List<string> BcgMenu { get; set; }

    [JsonPropertyName("videoMapIds")] public List<string> VideoMapIds { get; set; }
}
...
public class LineDefaults
{
    ...
    [JsonPropertyName("bcg")] public int Bcg { get; set; }

    [JsonPropertyName("filters")] public List<object> Filters { get; set; }
}
...
{
    [JsonPropertyName("runwayId")] public string RunwayId { get; set; }

    [JsonPropertyName("headingTolerance")] public int HeadingTolerance { get; set; }

    [JsonPropertyName("nearSideHalfWidth")]
    public double NearSideHalfWidth { get; set; }

    [JsonPropertyName("farSideHalfWidth")] public double FarSideHalfWidth { get; set; }

    [JsonPropertyName("nearSideDistance")] public double NearSideDistance { get; set; }

    [JsonPropertyName("regionLength")] public double RegionLength { get; set; }
    ...
    [JsonPropertyName("tieModeOffset")] public double TieModeOffset { get; set; }
...
public class Position
{
    ...
    [JsonPropertyName("runwayIds")] public List<object> RunwayIds { get; set; }

    [JsonPropertyName("starred")] public bool Starred { get; set; }

    [JsonPropertyName("radioName")] public string RadioName { get; set; }
...
public class VnasApiRoot
{
    ...
    [JsonPropertyName("videoMaps")] public List<VideoMap> VideoMaps { get; set; }
}
...
public class Rpc
{
    ...
    [JsonPropertyName("airportId")] public string AirportId { get; set; }
    ...
    [JsonPropertyName("masterRunway")] public MasterRunway MasterRunway { get; set; }

    [JsonPropertyName("slaveRunway")] public SlaveRunway SlaveRunway { get; set; }
}
...
public class RunwayConfiguration
{
    ...
    [JsonPropertyName("arrivalRunwayIds")] public List<string> ArrivalRunwayIds { get; set; }
...
public class ScratchpadRule
{
    ...
    [JsonPropertyName("airportIds")] public List<string> AirportIds { get; set; }

    [JsonPropertyName("searchPattern")] public string SearchPattern { get; set; }

    [JsonPropertyName("minAltitude")] public int MinAltitude { get; set; }
...
public class StarsConfiguration
{
    ...
    [JsonPropertyName("internalAirports")] public List<string> InternalAirports { get; set; }

    [JsonPropertyName("beaconCodeBanks")] public List<BeaconCodeBank> BeaconCodeBanks { get; set; }

    [JsonPropertyName("rpcs")] public List<Rpc> Rpcs { get; set; }

    [JsonPropertyName("scratchpadRules")] public List<ScratchpadRule> ScratchpadRules { get; set; }

    [JsonPropertyName("rnavPatterns")] public List<object> RnavPatterns { get; set; }
...
public class StarsHandoffId
{
    ...
    [JsonPropertyName("handoffCharacter")] public string HandoffCharacter { get; set; }
}
...
public class StripBay
{
    ...
    [JsonPropertyName("numberOfRacks")] public int NumberOfRacks { get; set; }
}
...
{
    [JsonPropertyName("mandatorySid")] public bool MandatorySid { get; set; }
    ...
    [JsonPropertyName("mandatoryDepFreq")] public bool MandatoryDepFreq { get; set; }

    [JsonPropertyName("mandatoryExpect")] public bool MandatoryExpect { get; set; }
    ...
    [JsonPropertyName("sids")] public List<Sid> Sids { get; set; }

    [JsonPropertyName("climbouts")] public List<Climbout> Climbouts { get; set; }

    [JsonPropertyName("climbvias")] public List<Climbvia> Climbvias { get; set; }

    [JsonPropertyName("initialAlts")] public List<InitialAlt> InitialAlts { get; set; }

    [JsonPropertyName("depFreqs")] public List<DepFreq> DepFreqs { get; set; }

    [JsonPropertyName("expects")] public List<Expect> Expects { get; set; }

    [JsonPropertyName("contactInfos")] public List<ContactInfo> ContactInfos { get; set; }

    [JsonPropertyName("localInfos")] public List<LocalInfo> LocalInfos { get; set; }

    [JsonPropertyName("defaultSidId")] public string DefaultSidId { get; set; }
...
public class TextDefaults
{
    ...
    [JsonPropertyName("opaque")] public bool Opaque { get; set; }
...
public class Transition
{
    ...
    [JsonPropertyName("defaultClimbvia")] public string DefaultClimbvia { get; set; }

    [JsonPropertyName("defaultDepFreq")] public string DefaultDepFreq { get; set; }

    [JsonPropertyName("firstRoutePoint")] public string FirstRoutePoint { get; set; }

    [JsonPropertyName("defaultExpect")] public string DefaultExpect { get; set; }
...
public class VideoMap
{
    ...
    [JsonPropertyName("sourceFileName")] public string SourceFileName { get; set; }
    ...
    [JsonPropertyName("starsId")] public int StarsId { get; set; }

    [JsonPropertyName("starsAlwaysVisible")]
    public bool StarsAlwaysVisible { get; set; }

    [JsonPropertyName("tdmOnly")] public bool TdmOnly { get; set; }
}
